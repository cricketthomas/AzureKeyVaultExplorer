...
public partial class DbContext : IDisposable
{
    ...
    public static async IAsyncEnumerable<QuickAccess> GetQuickAccessItemsAsyncEnumerable(string? tenantId = null)
    {
        using var connection = await TryCreateDatabaseAndOpenConnection();
        await connection.OpenAsync();
        using var command = connection.CreateCommand();
    ...
    public static async Task RemoveSubscriptionsBySubscriptionIDs(IEnumerable<string> subscriptionIds)
    {
        using var connection = await TryCreateDatabaseAndOpenConnection();
        await connection.OpenAsync();
        using var command = connection.CreateCommand();
    ...
    public static async Task InitializeDatabase()
    {
        ...
        string tableCommand = """
                ...
                -- Create all indexes in the same transaction
    ...
    public static async Task DropTablesAndRecreate()
    {
        using var connection = await TryCreateDatabaseAndOpenConnection();
        await connection.OpenAsync();
    ...
    public static async Task DeleteDatabaseFile()
    {
